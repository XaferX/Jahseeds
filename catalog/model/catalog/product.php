...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		WHERE
		pd2.product_id =
		p.product_id AND pd2.customer_group_id = '" . (int)$this->config->get('config_customer_group_id') . "'
		...
		AS reward, (SELECT ss.name FROM " . DB_PREFIX . "stock_status ss
		...
		if ($query->num_rows) {
			return array(
				...
				'meta_title'       => $query->row['seo_title'],
