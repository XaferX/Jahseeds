...
<link href="catalog/view/theme/micrablue/stylesheet/animate.css" rel="stylesheet">
<?php } ?>
<link href="catalog/view/theme/micrablue/stylesheet/jquery.mobile-menu.css" rel="stylesheet" type="text/css" >
...
<script src="catalog/view/theme/micrablue/js/jquery.mobile-menu.min.js" type="text/javascript"></script>
