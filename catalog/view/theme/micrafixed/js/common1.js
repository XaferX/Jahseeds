...
// jQuery(function () {
	...
	// jQuery('header, .navbar-collapse div[role="search"] button[type="reset"]').on('click keyup', function(event) {
	// console.log(event.currentTarget);
	// if (event.which == 27 && jQuery('.navbar-collapse div[role="search"]').hasClass('active') ||
	...
	// var jQueryform = jQuery('.navbar-collapse div[role="search"].active')
	// jQueryform.find('input').val('');
	// jQueryform.removeClass('active');
	// }
	
	// Show Search if form is not active // event.preventDefault() is important, this prevents the form from submitting
	// jQuery(document).on('click', '.navbar-collapse', function(event) {
		
	// event.preventDefault();
	// var jQueryform = jQuery(this).closest('.navbar-collapse');
