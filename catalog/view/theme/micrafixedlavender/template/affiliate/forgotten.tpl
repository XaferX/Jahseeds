  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="left">
        <a href="<?php echo $back; ?>"><button type="button" class="button btn btn-default"><?php echo $button_back; ?></button></a>
        <button type="submit" class="button continue btn btn-primary pull-right"><?php echo $button_continue; ?></button>
        </div>
        </div>
      </form>
      </div>
