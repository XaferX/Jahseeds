...
<link href="catalog/view/theme/micrayellow/stylesheet/stylesheet.css" rel="stylesheet">
<link href="catalog/view/theme/micrayellow/stylesheet/font-awesome.css" rel="stylesheet">
<?php if($config->get('magikmicra_animation_effects')==1) { ?>
<link href="catalog/view/theme/micrayellow/stylesheet/animate.css" rel="stylesheet">
<?php } ?>
<link href="catalog/view/theme/micrayellow/stylesheet/jquery.mobile-menu.css" rel="stylesheet" type="text/css" >
<link href="catalog/view/theme/micrayellow/stylesheet/style.css" rel="stylesheet">
...
<script src="catalog/view/theme/micrayellow/js/parallax.js" type="text/javascript"></script>
<script src="catalog/view/theme/micrayellow/js/common.js" type="text/javascript"></script>
<script src="catalog/view/theme/micrayellow/js/common1.js" type="text/javascript"></script>
<script src="catalog/view/javascript/jquery/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
<script src="catalog/view/theme/micrayellow/js/jquery.mobile-menu.min.js" type="text/javascript"></script>
<link href="catalog/view/theme/micrayellow/js/fancybox/jquery.fancybox.css" rel="stylesheet">
<script src="catalog/view/theme/micrayellow/js/fancybox/jquery.fancybox.js" type="text/javascript"></script>
<?php // external js end?>
