...
<link href="catalog/view/theme/micra/stylesheet/flexslider.css" rel="stylesheet">
        ...
        <div class="product-view">
          <div class="product-essential">
            ...
            <div class="product-shop col-sm-7 col-xs-12">
              ...
              <select name="option[<?php echo $option['product_option_id']; ?>]" onchange="ChangePrice()" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
...
<script type="text/javascript">
    function ChangePrice(){
        ...
        $(".magik-quickview .price").html(symbol+(new_price+def_price).toFixed(2));
