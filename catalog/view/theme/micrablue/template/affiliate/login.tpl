      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="well">
            ...
            <a class="" href="<?php echo $register; ?>"><button class="button create-account btn btn-primary"><?php echo $button_continue; ?></button></a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" class="button login btn btn-primary"><?php echo $button_login; ?></button>
              <?php if ($redirect) { ?>
