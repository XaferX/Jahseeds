...
<link href="catalog/view/theme/micralavender/stylesheet/stylesheet.css" rel="stylesheet">
<link href="catalog/view/theme/micralavender/stylesheet/font-awesome.css" rel="stylesheet">
<?php if($config->get('magikmicra_animation_effects')==1) { ?>
<link href="catalog/view/theme/micralavender/stylesheet/animate.css" rel="stylesheet">
<?php } ?>
<link href="catalog/view/theme/micralavender/stylesheet/jquery.mobile-menu.css" rel="stylesheet" type="text/css" >
<link href="catalog/view/theme/micralavender/stylesheet/style.css" rel="stylesheet">
...
<script src="catalog/view/theme/micralavender/js/parallax.js" type="text/javascript"></script>
<script src="catalog/view/theme/micralavender/js/common.js" type="text/javascript"></script>
<script src="catalog/view/theme/micralavender/js/common1.js" type="text/javascript"></script>
<script src="catalog/view/javascript/jquery/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
<script src="catalog/view/theme/micralavender/js/jquery.mobile-menu.min.js" type="text/javascript"></script>
<link href="catalog/view/theme/micralavender/js/fancybox/jquery.fancybox.css" rel="stylesheet">
<script src="catalog/view/theme/micralavender/js/fancybox/jquery.fancybox.js" type="text/javascript"></script>
<?php // external js end?>
