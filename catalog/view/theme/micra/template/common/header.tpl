        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-8 col-sm-9 col-xs-12">
            ...
            <div class="toplinks">
              ...
              <div class="welcome-msg hidden-xs border_cl"> <a href="<?=$contact?>"> Контакты</a></div>
              <div class="welcome-msg hidden-xs border_cl">FAQ</div>
              <div class="welcome-msg hidden-xs border_cl">Доставка/Оплата</div>
              <?php echo $language; ?>
              <?php echo $currency; ?>
...
if ($categories) { ?>
    ...
    <li class="level0 nav-5 level-top"><a class="active level-top" id="tab_home" href="<?php echo $home;?>"><span>
                <?php echo $text_home;?></span></a></li><?php }?>
...
<?php }?>
      ...
      if(!empty($customDataMenu)) { ?>
            ...
            if(!empty($subThumb)) { ?> 
            <div class="cat-img"><a title="" href="#">
                    <img  alt="product-image" src="<?php echo $this->model_tool_image->resize($subThumb[0]['image'], 160, 120) ; ?>"></a></div>
            <?php }
            } ?>
            <a href="<?php echo $category['children'][$i]['href']; ?>"><span>
                    <?php echo $category['children'][$i]['name']; ?></span></a>
            ...
            <li class="level2 nav-6-1-1">
                    <a href="<?php echo $category['children'][$i]['children'][$m]['href'];?>"><span>
                            <?php echo $category['children'][$i]['children'][$m]['name']?></span></a></li>
             ...
             //if($customDataMenu[0]['type']!=0){
                  ...
                  if($customDataMenu[0]['type']=='product')
                  {
                     ...
                     ?> 
                      ...
                      <div class="cat_img">
                          <a title="Magento Commerce" href="#">
                              <img alt="product-image" src="<?php echo $this->model_tool_image->resize($product_info['image'], 175, 175); ?>" width="175"></a></div>
